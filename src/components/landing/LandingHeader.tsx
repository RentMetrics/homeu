                    ...
                    <div className="hidden lg:flex items-center space-x-4">
                        {isLoaded && user ? (
                            <div className="flex items-center space-x-4">
                                <Link href="/dashboard" className="text-green-400 hover:text-green-300 font-medium transition-colors duration-200">
                                    Dashboard
                                </Link>
                            ...
                            <>
                                <SignInButton mode="modal">
                                    <button className="text-green-400 hover:text-green-300 font-medium transition-colors duration-200 cursor-pointer">
                                        Sign in
                                    </button>
                                </SignInButton>
                    ...
                    <div className="lg:hidden">
                        <div className="px-2 pt-2 pb-3 space-y-1 border-t border-gray-700">
                            ...
                            <div className="pt-4 border-t border-gray-700 space-y-2">
                                {isLoaded && user ? (
                                    <>
                                        <Link href="/dashboard" className="block w-full text-left px-3 py-2 text-green-400 hover:text-green-300 hover:bg-gray-800 rounded-md font-medium transition-colors duration-200">
                                            Dashboard
                                        </Link>
                                    ...
                                    <>
                                        <SignInButton mode="modal">
                                            <button className="block w-full text-left px-3 py-2 text-green-400 hover:text-green-300 hover:bg-gray-800 rounded-md font-medium transition-colors duration-200">
                                                Sign in
                                            </button>
                                        </SignInButton>
