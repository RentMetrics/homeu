                ...
                <div className="grid lg:grid-cols-2 gap-5 lg:gap-16 items-start lg:mb-16 mb-7">
                    ...
                    <div className="lg:pt-8 space-y-4">
                        ...
                        <p className="text-lg md:text-xl text-text-light leading-relaxed">
                          ...
                          {/* CTA Button */}
            <div className="pt-4">
              <Link href={"/"} className="bg-primary-main hover:bg-green-600 text-white font-semibold px-8 py-4 rounded-full text-lg transition-all duration-300 transform cursor-pointer hover:-translate-y-1 shadow-lg hover:shadow-xl">
                Search rentals
              </Link>
            </div>
                    </div>
