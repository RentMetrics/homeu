...
const rewardCategories = [
  ...
  },
  {
    id: "egift-cards",
    name: "eGift Cards",
    description: "Amazon, Target, Walmart & more",
    icon: Gift,
  ...
  },
  {
    id: "tickets",
    name: "Tickets",
    description: "Concerts, sports & events",
    icon: Ticket,
  ...
  },
  {
    id: "streaming",
    name: "Streaming",
    description: "Netflix, Spotify, Disney+ & more",
    icon: Tv,
...
// Popular specific items (inspired by the Awardco store)
const popularItems = [
  {
